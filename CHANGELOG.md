...
- Redesigned the faucet frontend: new hero illustration and typography, a public / private toggle with a single send button, inline minting and result views, a stats card for issuance and the faucet address, and dark mode ([#306](https://github.com/0xMiden/faucet/pull/306)).
